...
public class BraceSleepBean implements Comparable<Object>{
     ...
     * @param sleepUp       起床时间
     */
    public BraceSleepBean(String date, int cali_flag, int sleepQulity, int wakeCount, int deepSleepTime, int lowSleepTime, int allSleepTime, String sleepLine, CusVPTimeData sleepDown, CusVPTimeData sleepUp) {
        Date = date;
    ...
    public static String getBraceSleepBeanDate(CusVPTimeData time) {
    ...
    public int compareTo(Object another) {
        ...
        if (another instanceof BraceSleepBean) {
            BraceSleepBean sleepData = (BraceSleepBean)another;
